...
func BindBuffer(target int, b Buffer) {
	procBindBuffer.Call(uintptr(target), uintptr(b))
}

func BindFramebuffer(target int, b Buffer) {
	procBindFramebuffer.Call(uintptr(target), uintptr(b))
}

func BindRenderbuffer(target int, b Buffer) {
...
func CheckFramebufferStatus(target int) int {
	r0, _, _ := procCheckFramebufferStatus.Call(uintptr(target))
	return int(r0)
}
...
func CreateProgram() Program {
	r0, _, _ := procCreateProgram.Call()
	return Program(r0)
}

func CreateShader(ty int) Shader {
	r0, _, _ := procCreateShader.Call(uintptr(ty))
	return Shader(r0)
}
...
func DeleteFramebuffers(n int, framebuffers *Buffer) {
	procDeleteFramebuffers.Call(uintptr(n), uintptr(unsafe.Pointer(framebuffers)))
}

func DeleteFramebuffer(b Buffer) {
...
func DeleteRenderbuffers(n int, renderbuffers *Buffer) {
	procDeleteRenderbuffers.Call(uintptr(n), uintptr(unsafe.Pointer(renderbuffers)))
}

func DeleteRenderbuffer(b Buffer) {
...
func DrawElements(mode, count, ty, indices int) {
...
func FramebufferRenderbuffer(target, attachment, renderbuffertarget int, renderbuffer Buffer) {
...
func GetActiveUniform(program Program, i uint32) (string, int32, int) {
	buf := make([]byte, 1024)
	var length int
	var size int32
	var ty int
...
func GetAttribLocation(program Program, name string) int32 {
	cstr := unsafe.Pointer(C.CString(name))
	defer C.free(cstr)
	r0, _, _ := procGetAttribLocation.Call(uintptr(program), uintptr(cstr))
	return int32(r0)
}
...
func GetError() error {
	r0, _, _ := procGetError.Call()
	return int2error(int(r0))
}
...
func GetProgramiv(program Program, pname int) (i int32) {
...
func GetShaderiv(shader Shader, pname int) (params int32) {
...
func GetString(name int) unsafe.Pointer /*const GLubyte **/ {
	r0, _, _ := procGetString.Call(uintptr(name))
	return unsafe.Pointer /*const GLubyte **/ (r0)
}
...
func GetUniformLocation(program Program, name string) int {
	cstr := unsafe.Pointer(C.CString(name))
	defer C.free(cstr)
	r0, _, _ := procGetUniformLocation.Call(uintptr(program), uintptr(cstr))
	return int(r0)
}
...
func IsBuffer(buffer Buffer) bool {
	r0, _, _ := procIsBuffer.Call(uintptr(buffer))
	return r0 == TRUE
}

func IsEnabled(cap int) bool {
	r0, _, _ := procIsEnabled.Call(uintptr(cap))
	return r0 == TRUE
}

func IsFramebuffer(framebuffer Buffer) bool {
	r0, _, _ := procIsFramebuffer.Call(uintptr(framebuffer))
	return r0 == TRUE
}

func IsProgram(program Program) bool {
	r0, _, _ := procIsProgram.Call(uintptr(program))
	return r0 == TRUE
}

func IsRenderbuffer(renderbuffer uint32) int8 {
	r0, _, _ := procIsRenderbuffer.Call(uintptr(renderbuffer))
	return int8(r0)
}

func IsShader(shader Shader) bool {
	r0, _, _ := procIsShader.Call(uintptr(shader))
	return r0 == TRUE
}

func IsTexture(texture Texture) bool {
	r0, _, _ := procIsTexture.Call(uintptr(texture))
	return r0 == TRUE
}
...
func UniformMatrix3fv(location int, value *glm.Mat3x3) {
...
func UniformMatrix4fv(location int, value *glm.Mat4x4) {
